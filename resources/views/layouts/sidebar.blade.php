    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="/dashboard">
                        <p style="font-size: 25px">Tri Putra Lestari</p>
                    </a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Route::is('model-baju*') ? 'active' : '' }}">
                    <a href="{{ route('model-baju.index') }}" class='sidebar-link'>
                        <i class="bi bi-person-badge-fill"></i>
                        <span>Model Baju</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item {{ Route::is('bahan-baju*') ? 'active' : '' }}">
                    <a href="{{ route('bahan-baju.index') }}" class='sidebar-link'>
                        ...
                        <span>Bahan Baju</span>
                    </a>
                </li>

                <li class="sidebar-item {{ Route::is('ukuran*') ? 'active' : '' }}">
                    <a href="{{ route('ukuran.index') }}" class='sidebar-link'>
