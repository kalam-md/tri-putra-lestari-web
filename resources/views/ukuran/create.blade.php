                        ...
                        <form action="{{ route('ukuran.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('ukuran_baju') is-invalid @enderror" 
                                       id="ukuran_baju" name="ukuran_baju" value="{{ old('ukuran_baju') }}">
                                @error('ukuran_baju')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('panjang_badan') is-invalid @enderror" 
                                       id="panjang_badan" name="panjang_badan" value="{{ old('panjang_badan') }}">
                                @error('panjang_badan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('panjang_tangan') is-invalid @enderror" 
                                       id="panjang_tangan" name="panjang_tangan" value="{{ old('panjang_tangan') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('lebar_dada') is-invalid @enderror" 
                                       id="lebar_dada" name="lebar_dada" value="{{ old('lebar_dada') }}">
                                @error('lebar_dada')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
