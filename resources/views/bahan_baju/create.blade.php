        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('bahan-baju.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('motif_bahan') is-invalid @enderror" 
                                               id="motif_bahan" name="motif_bahan" value="{{ old('motif_bahan') }}">
                                        @error('motif_bahan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mt-3 text-center">
                                            <img id="image-preview" 
                                                 src="{{ asset('images/default-image.webp') }}" 
                                                 alt="Preview Gambar" 
...
<script>
    function previewImage(event) {
        ...
        if (input.files && input.files[0]) {
            ...
            preview.src = "{{ asset('images/default-image.webp') }}";
        }
    }
</script>