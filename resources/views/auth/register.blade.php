...
<head>
    ...
    <title>Register - Tri Putra Lestari</title>
...
<body>
    ...
    <div id="auth">    
        <div class="row h-100 d-flex justify-content-center align-items-center">
            <div class="col-5">
                <div>
                    <h1 class="auth-title text-center mb-4">Registrasi Akun</h1>
                    ...
                    <form action="{{ route('register.store') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="nama_lengkap" class="form-control form-control-xl @error('nama_lengkap') is-invalid @enderror" placeholder="Nama Lengkap" value="{{ old('nama_lengkap') }}">
